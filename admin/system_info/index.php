		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile1" name="logo" onchange="displayImg(this,$(this))">
			...
			<div class="form-group">
				...
				<div class="custom-file">
	              <input type="file" class="custom-file-input rounded-circle" id="customFile2" name="bg" onchange="displayImg2(this,$(this))">
